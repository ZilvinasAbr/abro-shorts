...
> **Note for Electron/Client-Side Applications:**
> This version has been filtered to remove Next.js and server-side rendering (SSR) specific rules. Only client-side React best practices are included.

---

## Abstract

Comprehensive performance optimization guide for React applications, designed for AI agents and LLMs. Contains 42 rules across 5 categories, prioritized by impact from critical (eliminating waterfalls, reducing bundle size) to incremental (advanced patterns). Each rule includes detailed explanations, real-world examples comparing incorrect vs. correct implementations, and specific impact metrics to guide automated refactoring and code generation. Server-side rendering, Next.js-specific, and SSR hydration rules have been removed for use in client-side React applications like Electron SPAs.
